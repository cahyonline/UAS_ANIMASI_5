...
namespace UnityTutorial.PlayerControl
{
    public class PlayerController : MonoBehaviour
    {
        ...
        //[SerializeField] private Vector3 ThirdPersonOffset = new Vector3(0, 2, -4); // Offset for third-person camera
        ...
        //    _currentYaw += Mouse_X * MouseSensitivity * Time.smoothDeltaTime;
        //    _xRotation -= Mouse_Y * MouseSensitivity * Time.smoothDeltaTime;
        //    _xRotation = Mathf.Clamp(_xRotation, UpperLimit, BottomLimit);

        //    // Calculate camera position and rotation for third-person
        //    Quaternion rotation = Quaternion.Euler(_xRotation, _currentYaw, 0);
        //    Vector3 desiredPosition = CameraRoot.position + rotation * ThirdPersonOffset;

        //    Camera.position = desiredPosition;
        //    Camera.rotation = rotation;

        //    // Rotate player only on Y axis (yaw)
        //    _playerRigidbody.MoveRotation(Quaternion.Euler(0, _currentYaw, 0));
        //}
